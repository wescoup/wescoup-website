...
@app.route("/tonys-tennis-calculator-2x2")
def tonys_tennis_calculator_2x2():
    """Show Tony's Tennis 2x2 Strategy Calculator page"""
    return render_template("tennis/tonys-tennis-calculator-2x2.html")
...
@app.route("/tonys-pickleball-doubles-instructions")
def tonys_pickleball_doubles_instructions():
    """Show the instructions page for the pickleball doubles tracker"""
    return render_template("pickleball/tonys-pickleball-instructions.html")
